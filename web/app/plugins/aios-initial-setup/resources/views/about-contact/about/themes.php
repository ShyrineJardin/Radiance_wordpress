<div class="wpui-row wpui-templates">
	<?php foreach ($about_templates as $template) : ?>
            ...
            <div class="wpui-template <?=$template['active'] ? "active-template" : ""?> <?=($template['available'] ? '' : 'wpui-template-lock')?>">
                ...
                <?php if ($template['available']) : ?>
                    <div class="wpui-details">
                        ...
                        <?php else: ?>
                            <a href="" class="wpui-template-activator" data-theme-name="about-theme" data-theme-value="<?=$template['fullname']?>" data-theme-slug="<?=$template['name']?>">Activate</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
