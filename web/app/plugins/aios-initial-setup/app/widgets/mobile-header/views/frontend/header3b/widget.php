	...
	<div class="amh-fixed-header-nav amh-area-wrap">
		<div class="amh-header-buttons amh-3b amh-clearfix">
			...
			<div class="amh-center">
				<?php if ( !$phone_hide ) : ?>
					<?php if ( empty( $phone2 ) ): ?>
						<a href="tel:<?php echo do_shortcode( $phone_href ) ?>" class="amh-phone"><span class="ai-font-phone-o"><span class="amh-phone-text-hide"><?php echo do_shortcode( $phone ) ?></span></span></a>
					<?php else: ?>
						<a href="#" class="amh-phone amh-header-phone-list-trigger"><span class="ai-font-phone-o"><span class="amh-phone-text-hide"><?php echo do_shortcode( $phone ) ?></span></span></a>
					<?php endif ?>
				<?php endif ?>
			</div>
			...
			<div class="amh-header-right-btn">
				<?php if ( !$email_hide ) : ?>
					<?php if ( !shortcode_exists('mail_to') ) : ?>
						<a class="amh-email" href="mailto:<?php echo do_shortcode( $email )?>"><span class="ai-font-envelope-o"><span class="amh-email-text-hide"><?php echo do_shortcode( $email )?></span></span></a>
					<?php elseif ( shortcode_exists('mail_to') ) : ?>
						<?php echo do_shortcode( '[mail_to email="' . do_shortcode( $email ). '"]<span class="amh-email"><span class="ai-font-envelope-o"><span class="amh-email-text-hide">' . do_shortcode( $email ) . '</span></span></span>[/mail_to]' ) ?>
					<?php endif ?>
				<?php endif ?>
			</div>
