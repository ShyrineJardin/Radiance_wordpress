...
class Module
{
	...
	public function enqueueAssetsForFix() {
		...
		if ( file_exists( $file_path ) ) {
			...
			wp_register_script('contact-form-7', $file_url, ['jquery', 'swv'], WPCF7_VERSION, $in_footer);
	...
	public function fixScripts() {
		...
		if($access_type === 'direct')
		{
			...
			$corrected_scripts = str_replace(	"if ( typeof window.wp !== 'function' && typeof window.FormData !== 'function' ) {",
				"if ( typeof window.FormData === 'undefined' ) {",
				$scripts_content);

			/* Save corrected scripts file */
			$folder = WP_CONTENT_DIR . DIRECTORY_SEPARATOR . 'aios-initial-setup-cf7-formdata-compatibility';
