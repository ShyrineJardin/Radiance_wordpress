<?php
    ...
    $templateOption = get_option(AIOS_AUTO_GENERATE_PAGES, []);
    $templateData = [
        'type' => 'agent-pro',
        'theme' => 'default'
    ];

    if (isset($templateOption[get_the_ID()])) {
        $templateData = $templateOption[get_the_ID()];
    }

    $hideTitle = $templateData['type'] == 'amante-ii' ? 'hide' : '';
?>

<div id="ip-<?=$templateData['type']?>-<?=$templateData['theme']?>" class="aios-auto-generate-page">
