...
if ( !class_exists( 'aios_communities_details_page_template_seneca' ) ) {

	class aios_communities_details_page_template_seneca{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/seneca';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/seneca';
			$this->add_actions();
...
$aios_communities_details_page_template_seneca = new aios_communities_details_page_template_seneca();