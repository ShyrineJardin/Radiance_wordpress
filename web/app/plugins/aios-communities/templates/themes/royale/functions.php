...
if ( !class_exists( 'aios_communities_details_page_template_royale' ) ) {

	class aios_communities_details_page_template_royale{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/royale';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/royale';
			$this->add_actions();
...
$aios_communities_details_page_template_royale = new aios_communities_details_page_template_royale();