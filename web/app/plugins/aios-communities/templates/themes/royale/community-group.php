...
<?php do_action('aios_starter_theme_before_inner_page_content') ?>
    ...
    ?>
        ...
        <div class="aios-communities-royale">
                ...
                <?php
                    ...
                    if (!empty($community_query)) {
                        ...
                        foreach($community_query  as $term){
                                ...
                                echo '<div class="aioscomu-box '.$show_overlay.' '.$text_shadow.'" data-aos="fade-up"  data-aos-duration="500" data-aos-once="true">
                                <a href="'.$term_permalink.'">
                                    <div class="aioscomu-img">
                                        <div class="aioscom-overlay"></div>
                                        <canvas width="530" height="405" style="background-image: url('.wp_get_attachment_url($taxonomy_meta['banner']).');"></canvas>
                                        '.$banner_image.'
                                    </div>
                                    <div class="aioscomu-txt">
                                        <div><span>'.$term_name.'</span></div>
                                    </div>
                                </a>
                            </div>';
                        }
