...
if ( !class_exists( 'aios_communities_details_page_template_minimalist' ) ) {

	class aios_communities_details_page_template_minimalist{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/minimalist';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/minimalist';
			$this->add_actions();
		...
		*/
		public function enqueue_scripts() {
			...
			if ( $main_page == get_the_ID() && get_the_ID() != 0 ||  is_tax( 'community-group') ) {
				wp_enqueue_style( 'aios_communties_archive_style', $this->active_template_url . '/css/archive.css' );
				wp_enqueue_script( 'aios_communties_archive_script', $this->active_template_url . '/js/script.js' );
...
$aios_communities_details_page_template_minimalist = new aios_communities_details_page_template_minimalist();