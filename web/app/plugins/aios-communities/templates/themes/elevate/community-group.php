...
<section class="aios-communities-page hfeed">
    ...
    <div class="aiosCommunitiesElevate">
        <div class="aiosCommunitiesElevate__container">
            <div class="aiosCommunitiesElevate__items">
                <?php
                    if (!empty($community_query)) {
                        ...
                        foreach($community_query  as $term){
                            ...
                            echo '<div class="aiosCommunitiesElevate__item  '.$show_overlay.' '.$text_shadow.'">
                                    <a href="'.$term_permalink.'" termid="'.$term_id.'">
                                        <canvas width="720" height="400"></canvas>
                                        '.$banner_image.'
                                        <span class="aiosCommunitiesElevate__item--title">'.$term_name.'</span>
                                    </a>
                                </div>';
                        }
                    } else {
                        echo '<div class="aiosCommunitiesElevate__notfound">No Community Was Found.</div>';
                    }
                ?>       
            </div>

            <div class="aiosCommunitiesElevate__pagination">
                <?php
