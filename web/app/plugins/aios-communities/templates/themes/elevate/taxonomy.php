...
<section class="aios-communities-page hfeed">
    ...
    <div class="aiosCommunitiesElevate">
        <div class="aiosCommunitiesElevate__container">
            ...
            ?>
                <div class="aiosCommunitiesElevate__item <?= $text_shadow?> <?= $show_overlay ?>">
                    <a href="<?= $permalink ?>" <?= ! empty( $aios_idxBrokerLink ) ? $newTab : '' ?>>
                        ...
                        <?php else : ?>
                            ...
                            <?php endif ?>
                        <?php endif; ?>
                        <span class="aiosCommunitiesElevate__item--title"><?=$title?></span>
                    </a>
                </div>
            <?php endwhile; ?>
            <?php else: ?>
                <div class="aiosCommunitiesElevate__notfound">No Community Was Found.</div>
            <?php endif; ?>
            </div>
