...
<section class="aios-communities-page hfeed">
    ...
    <div class="aiosCommunitiesPanorama">
        <div class="aiosCommunitiesPanorama__container">
            <div class="aiosCommunitiesPanorama__row">
                ...
                <?php
                    if (!empty($community_query)) {
                        foreach($community_query  as $term){
                            ...
                            echo '<div class="aiosCommunitiesPanorama__col '.$show_overlay.' '.$text_shadow.'">
                                <a href="'.$term_permalink.'" termid="'.$term_id.'">
                                    <div class="aiosCommunitiesPanorama__img">
                                        '.$banner_image. '
                                        <canvas width="315" height="539"></canvas>
                                    </div>
                                    <div class="aiosCommunitiesPanorama__info">
                                        <div class="aiosCommunitiesPanorama__name">'.$term_name.'</div>
                                        <div class="aiosCommunitiesPanorama__link">
                                            <span role="button" aria-pressed="false">View Area +</span>
                                        </div>
                                    </div>
                                </a>
                            </div>';
