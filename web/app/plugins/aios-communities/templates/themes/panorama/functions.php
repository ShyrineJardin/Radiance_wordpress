...
if ( !class_exists( 'aios_communities_details_page_template_panorama' ) ) {

	class aios_communities_details_page_template_panorama{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/panorama';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/panorama';
			$this->add_actions();
...
$aios_communities_details_page_template_panorama = new aios_communities_details_page_template_panorama();