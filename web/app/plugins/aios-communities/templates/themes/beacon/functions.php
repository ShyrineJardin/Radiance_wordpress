...
if ( !class_exists( 'aios_communities_details_page_template_beacon' ) ) {

	class aios_communities_details_page_template_beacon{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/beacon';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/beacon';
			$this->add_actions();
...
$aios_communities_details_page_template_beacon = new aios_communities_details_page_template_beacon();