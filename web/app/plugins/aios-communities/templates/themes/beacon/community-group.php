...
<section class="aios-communities-page hfeed">
    ...
    <div class="aiosCommunitiesBeacon">
        <div class="aiosCommunitiesBeacon__container">
            <div class="aiosCommunitiesBeacon__row">
                ...
                <?php
                    if (!empty($community_query)) {
                        ...
                        foreach($community_query  as $term){
                            ...
                            echo '<div class="aiosCommunitiesBeacon__col '.$show_overlay.' '.$text_shadow.'">
                                <a href="'.$term_permalink.'" termid="'.$term_id.'">
                                    <div class="aiosCommunitiesBeacon__img">
                                        <canvas width="555" height="246"></canvas>
                                        '.$banner_image.'
                                    </div>
                                    <div class="aiosCommunitiesBeacon__content">
                                        <h3>'.$term_name.'</h3>
                                    </div>
                                </a>
                            </div>';
