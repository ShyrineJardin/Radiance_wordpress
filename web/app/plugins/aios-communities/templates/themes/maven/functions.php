...
if ( !class_exists( 'aios_communities_details_page_template_maven' ) ) {

	class aios_communities_details_page_template_maven{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/maven';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/maven';
			$this->add_actions();
...
$aios_communities_details_page_template_maven = new aios_communities_details_page_template_maven();