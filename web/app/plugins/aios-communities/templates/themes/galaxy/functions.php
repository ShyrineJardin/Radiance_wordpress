...
if ( !class_exists( 'aios_communities_details_page_template_galaxy' ) ) {

	class aios_communities_details_page_template_galaxy{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/galaxy';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/galaxy';
			$this->add_actions();
...
$aios_communities_details_page_template_galaxy = new aios_communities_details_page_template_galaxy();