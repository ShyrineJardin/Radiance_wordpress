                        ...
                        <?php
                            if (!empty($community_query)) {
                                foreach($community_query  as $term){
                                    ...
                                    echo '<a href="'.$term_permalink.'" class="aioscomu-cont">
                                            <div class="img-holder"><canvas width="533" height="468"></canvas>'.$banner_image.'</div>
                                            <div class="aioscomu-details">'.$term_name.'</div>
                                        </a>';
                                }
                            } else {
