...
if ( !class_exists( 'aios_communities_details_page_template_metropolitan' ) ) {

	class aios_communities_details_page_template_metropolitan{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/metropolitan';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/metropolitan';
			$this->add_actions();
...
$aios_communities_details_page_template_metropolitan = new aios_communities_details_page_template_metropolitan();