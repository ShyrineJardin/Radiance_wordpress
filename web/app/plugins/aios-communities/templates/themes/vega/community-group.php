             ...
             <?php
                if (!empty($community_query)) {
                    foreach($community_query  as $term){
                        ...
                        echo '<div class="aios-communities-vega-col '.$show_overlay.' '.$text_shadow.'" data-aios-communities-vega-post="'.$term_id.'">
                            <a href="'.$term_permalink.'" class="aios-communities-vega-item">
                                ...
                                <div class="aios-communities-vega-info">
                                    <strong class="aios-communities-vega-name">'.$term_name.'</strong>
