...
if ( !class_exists( 'aios_communities_details_page_template_vega' ) ) {

	class aios_communities_details_page_template_vega{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/vega';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/vega';
			$this->add_actions();
...
$aios_communities_details_page_template_vega = new aios_communities_details_page_template_vega();