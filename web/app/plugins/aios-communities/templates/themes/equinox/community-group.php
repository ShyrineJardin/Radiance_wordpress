            ...
            <?php
                if (!empty($community_query)) {
                    ...
                    foreach($community_query  as $term){
                        ...
                        echo '<div class="aiosCommunitiesEquinox__item '.$show_overlay.' '.$text_shadow.'">
                            <a href="'.$term_permalink.'" termid="'.$term_id.'">
                                <canvas width="338" height="440"></canvas>
                               '.$banner_image.'
                                <span class="aiosCommunitiesEquinox__item--title">'.$term_name.'</span>
                            </a>
                        </div>';
                    }
                } else {
                    echo '<div class="aiosCommunitiesEquinox__notfound">No Community Was Found.</div>';
                }
            ?>       
