...
if ( !class_exists( 'aios_communities_details_page_template_equinox' ) ) {

	class aios_communities_details_page_template_equinox {
		...
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/equinox';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/equinox';
			$this->add_actions();
		...
		*/
		...
		public function enqueue_scripts() {
			...
			if ( $main_page == $post_id && $post_id != 0 ||  is_tax( 'community-group') ) {
				wp_enqueue_style( 'aios_communties_archive', $this->active_template_url . '/assets/css/archives.min.css' );
    ...
    $aios_communities_details_page_template_equinox = new aios_communities_details_page_template_equinox();
}