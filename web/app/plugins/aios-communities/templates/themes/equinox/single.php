                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <?php
                        ...
                        if ( !is_custom_field_banner( get_queried_object() ) || $aios_metaboxes_banner_title_layout[1] != 1 ) {
                            ...
                            echo '<h1 class="entry-title hidden-md hidden-lg">' . $aioscm_title . '</h1>';
                        }
                    ?>
                                ...
                                foreach ( $options[0] as $k => $data ) {
                                    ...
                                    if ( isset( $data['title'] ) && ! empty( $data['title'] ) ) {
                                        ...
                                        if ( ! isset( $data['title_hide'] ) && empty( $data['title_hide'] ) ) {
                                            $contentTitle = "<h2>" . ( $data['title'] === "Introduction" ? get_the_title() : $data['title'] ) . "</h2>";
                                        }
                            ...
                            <?php if (!empty($aios_display_cta)) : ?>
                                <div class="community-cta">
                                    <div class="siteButton siteButton--mobileFull">
                                        <a href="<?= $aios_cta_link ? $aios_cta_link : '#aios-communities-scroll-to' ?>" <?= !empty($aios_cta_new_tab) ? 'target="_blank"' : '' ?> <?= $aios_cta_link ? '' : 'class="aios-communities-scroll-to"' ?> > <?= $aios_cta_title ? $aios_cta_title : 'View All ' . get_the_title() . ' Listings' ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
