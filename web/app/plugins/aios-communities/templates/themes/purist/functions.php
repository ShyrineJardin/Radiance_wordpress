...
if ( !class_exists( 'aios_communities_details_page_template_purist' ) ) {

	class aios_communities_details_page_template_purist{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/purist';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/purist';
			$this->add_actions();
...
$aios_communities_details_page_template_purist = new aios_communities_details_page_template_purist();