...
if ( !class_exists( 'aios_communities_details_page_template_quantum' ) ) {

	class aios_communities_details_page_template_quantum{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/quantum';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/quantum';
			$this->add_actions();
...
$aios_communities_details_page_template_quantum = new aios_communities_details_page_template_quantum();