...
<?php do_action('aios_starter_theme_before_inner_page_content') ?>
    ...
    <section id="aios-communities-quantum" data-pattern="2" style="padding-top:0">
        <div>
                    ...
                    <?php
                        ...
                        if (!empty($community_query)) {
                            foreach($community_query  as $term){
                                ...
                                echo '<div class="aioscomu-col '.$show_overlay.' '.$text_shadow.'" data-aos="fade-up"  data-aos-duration="500" data-aos-once="true">
                                <a href="'.$term_permalink.'">
                                    ...
                                    <div class="aioscomu-txt">
                                        <div>
                                            ...
                                            <span class="site-link">Learn More</span>
                                        </div>
                                    </div>
                                </a>
                            </div>';
