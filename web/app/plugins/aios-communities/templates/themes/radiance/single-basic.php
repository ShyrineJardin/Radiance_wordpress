                    ...
                    <div class="entry entry-content">
                        ...
                        <div class="community-content">
                            <?php
                                ...
                                $is_custom_banner = !is_custom_field_banner(get_queried_object()) || $aios_metaboxes_banner_title_layout[1] != 1;
                                ...
                                $title_html = $is_custom_banner ? '<h1 class="entry-title">' . $aioscm_title . '</h1>' : '<h2 class="heading-1">' . get_the_title() . '</h2>';
                            ?>

                            <div class="community-title community-title--mobile">
                                <?= $title_html; ?>
                            </div>
                            ...
                            <?php if (!empty($aios_display_cta)) : ?>
                                <div class="community-cta">
                                    <div class="siteButton siteButton--mobileFull">
                                        <a href="<?= $aios_cta_link ? $aios_cta_link : '#aios-communities-scroll-to' ?>" <?= !empty($aios_cta_new_tab) ? 'target="_blank"' : '' ?> <?= $aios_cta_link ? '' : 'class="aios-communities-scroll-to"' ?> > <span><?= $aios_cta_title ? $aios_cta_title : 'View Available Listings' ?></span></a>
                                    </div>
                                </div>
                            <?php endif; ?>
