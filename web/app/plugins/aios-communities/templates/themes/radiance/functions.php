...
if ( !class_exists( 'aios_communities_details_page_template_radiance' ) ) {

	class aios_communities_details_page_template_radiance {
		...
		public function __construct() 
        {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/radiance';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/radiance';
			$this->add_actions();
		}
    ...
    $aios_communities_details_page_template_radiance = new aios_communities_details_page_template_radiance();
}