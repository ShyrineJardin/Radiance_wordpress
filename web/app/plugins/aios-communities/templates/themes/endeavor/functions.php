...
if ( !class_exists( 'aios_communities_details_page_template_endeavor' ) ) {

	class aios_communities_details_page_template_endeavor{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/endeavor';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/endeavor';
			$this->add_actions();
		}
...
$aios_communities_details_page_template_endeavor = new aios_communities_details_page_template_endeavor();