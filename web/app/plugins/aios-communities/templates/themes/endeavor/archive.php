...
<section class="aios-communities-page hfeed">
    ...
    <div class="aiosCommunitiesEndeavor">
        <div class="aiosCommunitiesEndeavor__container">
            <div class="aiosCommunitiesEndeavor__row">
                <?php if($community_query->have_posts()) : ?>
                <?php while($community_query->have_posts()) : $community_query->the_post(); ?>

                <div class="aiosCommunitiesEndeavor__col <?= $text_shadow?> <?= $show_overlay ?>">
                    ...
                    <a href="<?= $permalink ?>" data-communities-id="<?= $post_id ?>" <?= !empty($aios_idxBrokerLink) ? $newTab : '' ?>>
                        <div class="aiosCommunitiesEndeavor__img">
                            <canvas width="400" height="501"></canvas>
                        ...
                        <div class="aiosCommunitiesEndeavor__content">
                            <h3><?php the_title(); ?></h3>
