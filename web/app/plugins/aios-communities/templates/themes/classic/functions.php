...
if ( !class_exists( 'aios_communities_details_page_template_classic' ) ) {

	class aios_communities_details_page_template_classic{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/classic';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/classic';
			$this->add_actions();
...
$aios_communities_details_page_template_classic = new aios_communities_details_page_template_classic();