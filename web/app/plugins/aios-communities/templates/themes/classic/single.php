	...
	<article id="content" class="hfeed">
        ...
        <?php if(have_posts()) : ?>
            ...
            <?php while(have_posts()) : the_post(); ?>
                ...
                <div id="ai-classic-communities-details-wrap">
                    <div class="ai-classic-communities-details-content">
                       
                        <?php if($remove_featured_image != 'true') : ?>
                            <?php if (has_post_thumbnail( $post_id ) ): ?>
                                <div class="ai-classic-communities-details-image">                                
                                    <?= get_the_post_thumbnail(null, 'full'); ?>
                                    <canvas width="620" height="477"></canvas>
                                </div><!-- end of communties image -->
                            <?php endif; ?>
                        <?php endif; ?>


                        <div class="ai-classic-communities-details-text">    
                                <?php
                                        ...
                                        if ( !is_custom_field_banner( get_queried_object() ) || $aios_metaboxes_banner_title_layout[1] != 1 ) {
                                            ...
                                            echo '<h1 class="entry-title"> <span>';
                                            echo $aioscm_title;
                                            echo '</span></h1>';
                                    }
                                ?>
