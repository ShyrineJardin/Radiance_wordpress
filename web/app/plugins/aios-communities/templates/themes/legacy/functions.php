...
if (!class_exists('aios_communities_details_page_template_legacy')) {

	class aios_communities_details_page_template_legacy
	{
		...
		*/
		public function __construct()
		{
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/legacy';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/legacy';
			$this->add_actions();
		}
...
$aios_communities_details_page_template_legacy = new aios_communities_details_page_template_legacy();
