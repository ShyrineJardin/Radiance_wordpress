...
if ( !class_exists( 'aios_communities_details_page_template_modern' ) ) {

	class aios_communities_details_page_template_modern{
		...
		*/
		public function __construct() {
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/modern';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/modern';
			$this->add_actions();
...
$aios_communities_details_page_template_modern = new aios_communities_details_page_template_modern();