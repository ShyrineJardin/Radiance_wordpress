...
if (!class_exists('aios_communities_details_page_template_element')) {

	class aios_communities_details_page_template_element
	{
		...
		*/
		public function __construct()
		{
			...
			$this->active_template_url = AIOS_COMMUNITIES_URL . 'templates/themes/element';
			$this->active_template_dir = AIOS_COMMUNITIES_DIR . '/templates/themes/element';
			$this->add_actions();
		}
...
$aios_communities_details_page_template_element = new aios_communities_details_page_template_element();
