...
<section class="aios-communities-page hfeed">
    <div id="content" class="aiosCommunitiesAscend--title">
    ...
    <div class="aiosCommunitiesAscend">
        <div class="aiosCommunitiesAscend__container">

            <div class="aiosCommunitiesAscend__items">
                <?php 
                ...
                ?>
                    <div class="aiosCommunitiesAscend__item <?= $text_shadow?> <?= $show_overlay ?>">
                        <a href="<?= $permalink ?>" <?= !empty( $aios_idxBrokerLink ) ? $newTab : '' ?>>
                            ...
                            <?php else : ?>
                                ...
                                <?php endif ?>
                            <?php endif; ?>
                            <span class="aiosCommunitiesAscend__item--title"><?=$title?></span>
                        </a>
                    </div>
                <?php endwhile; ?>
                <?php else: ?>
                    <div class="aiosCommunitiesAscend__notfound">No Community Was Found.</div>
                <?php endif; ?>
            </div>

            <div class="aiosCommunitiesAscend__pagination">
                <?php
