                            ...
                            <?php if (!empty($aios_display_cta)) : ?>
                                <div class="community-cta">
                                    <div class="siteButton siteButton--mobileFull">
                                        <a href="<?= $aios_cta_link ? $aios_cta_link : '#featuredproperties' ?>" <?= !empty($aios_cta_new_tab) ? 'target="_blank"' : '' ?> <?= $aios_cta_link ? '' : 'class="aios-communities-scroll-to"' ?> > <?= $aios_cta_title ? $aios_cta_title : 'View Available ' . get_the_title() . ' Listings' ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
