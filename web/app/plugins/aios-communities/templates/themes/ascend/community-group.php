                ...
                <?php
                    if (!empty($community_query)) {
                        ...
                        foreach($community_query  as $term){
                            ...
                            echo ' <div class="aiosCommunitiesAscend__item '.$show_overlay.' '.$text_shadow.'">
                                <a href="'.$term_permalink.'" termid="'.$term_id.'">
                                    <canvas width="720" height="400"></canvas>
                                    '.$banner_image.'
                                    <span class="aiosCommunitiesAscend__item--title">'.$term_name.'</span>
                                </a>
                            </div>';
                        }
                    } else {
                        echo '  <div class="aiosCommunitiesAscend__notfound">No Community Was Found.</div>';
                    }
                ?>       
            </div>
